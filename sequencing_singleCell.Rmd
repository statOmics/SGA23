...
```{r applications, out.width="100%", fig.cap="Hwang et al. 2018, doi: 10.1038/s12276-018-0071-8", echo=FALSE}
...
```{r bulkVsSc2, fig.cap="Image credit: Davide Risso", echo=FALSE}
...
```{r protocols, fig.cap="Griffiths et al., 2018, doi.org/10.15252/msb.20178046", echo=FALSE}
include_graphics("./images_sequencing/scRNA-seqTechnologies.png")
```

<br/><br/>

```{r umi2, fig.cap="Image credit: Davide Risso", echo=FALSE}
...
```{r kangMultiplex, fig.cap="Kang et al. 2018, doi: 10.1038/nbt.4042", echo=FALSE}
...
```{r oscaworkflow, fig.cap="Image credit: OSCA book", echo=FALSE}
...
```{r singleCellExperiment, fig.cap="Image credit: OSCA book", echo=FALSE}
...
```{r scDbiFinder, fig.cap="Germain et al. 2021, doi: 10.12688/f1000research.73600.2"}
...
```{r glmPCAFig2, fig.cap="Townes et al. 2019, DOI: 10.1186/s13059-019-1861-6"}
...
```{r lunNormalisation, fig.cap="Lun et al. 2016, DOI: 10.1186/s13059-016-0947-7", echo=FALSE}
...
```{r lunNormalisation2, fig.cap="Lun et al. 2016, DOI: 10.1186/s13059-016-0947-7", echo=FALSE}
...
```{r glmPCAFig2Rep, fig.cap="Townes et al. 2019, DOI: 10.1186/s13059-019-1861-6", echo=FALSE}
knitr::include_graphics("./images_sequencing/glmPCAFig2.png")
```
...
```{r pseudoReplicationAUC, fig.cap="Squair et al. 2021 (DOI 10.1038/s41467-021-25960-2)", echo=FALSE}
