...
- We know two points of the plane $(\boldsymbol{\beta}^k,S(\boldsymbol{\beta}^k))$ and $(\boldsymbol{\beta}^{k+1},0)$
...
## Application to Poisson example 
...
```{r caption=" Robinson and Oshlack (2010). Genome Biology."}
