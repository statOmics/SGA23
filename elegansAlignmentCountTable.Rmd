...
download.file(url,"elegansFastq.zip")
unzip("elegansFastq.zip", exdir = "./")
```
...
We will make the input file for the hisat aligner that will be called through the QuasR package. 
...
### Download C. elegans genome and gtf file 

![]("https://raw.githubusercontent.com/statOmics/SGA/master/images_sequencing/humanReferenceGenome.pdf")

![]("https://raw.githubusercontent.com/statOmics/SGA/master/images_sequencing/humanReferenceTranscriptome.pdf]

```{r}
download.file(url = "https://ftp.ensembl.org/pub/release-108/fasta/caenorhabditis_elegans/dna/Caenorhabditis_elegans.WBcel235.dna.toplevel.fa.gz",
              destfile = "Caenorhabditis_elegans.WBcel235.dna.toplevel.fa.gz")
download.file(url = "https://ftp.ensembl.org/pub/release-108/gtf/caenorhabditis_elegans/Caenorhabditis_elegans.WBcel235.108.gtf.gz",
              destfile = "Caenorhabditis_elegans.WBcel235.108.gtf.gz")
gunzip("Caenorhabditis_elegans.WBcel235.dna.toplevel.fa.gz")
gunzip("Caenorhabditis_elegans.WBcel235.108.gtf.gz")
list.files()
```
...
### Convert gtf file into database

The gtf file contains information on the position of features, e.g. exons and genes, along the chromosome. 
...
annotFile <- "Caenorhabditis_elegans.WBcel235.108.gtf"
...
```{r}
geneCounts <- qCount(projE, txdb, reportLevel = "gene")
head(geneCounts)
```
